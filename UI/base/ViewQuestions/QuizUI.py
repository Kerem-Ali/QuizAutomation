...
from .QuestionUISolve import QuestionUISolve
...
class QuizUI(QtWidgets.QWidget):
    ...
    def commitResult(self):
        ...
        correct=sum([x.correct==x.selected for i,x in enumerate(self.quiz.questions)])
        notAnswered=sum([x.selected==0 for i,x in enumerate(self.quiz.questions)])
        incorrect=total-(correct+notAnswered)
        print("total questions:",total)
        print("Correct Answers:",correct)
        print("Incorrect Answers:",incorrect)
        print("Not answered :",notAnswered)

        self.rdm.commitUserResults(self.user,self.quiz)
